...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a ahchain testnet",
...
Example:
	ahchaind testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "ahchaind",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "ahchaincli",
