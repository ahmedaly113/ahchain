...
func (app *ahchain) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *ahchain) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
